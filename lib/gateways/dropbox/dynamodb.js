...
const toDropboxModel = dropbox => ({
  ...
  firstName: dropbox.customer && dropbox.customer.firstName,
  dob: dropbox.customer && dropbox.customer.dob,
  parentsEmail: dropbox.customer && dropbox.customer.parentsEmail,
  lastName: dropbox.customer && dropbox.customer.lastName,
  archived: dropbox.archived,
  rejectReason: dropbox.rejectReason
});
  ...
  return new Dropbox({
    ...
    customer:
      ...
      new Customer({
        ...
        parentsEmail: model.parentsEmail,
